        ...
        <div className="card direct-chat direct-chat-primary">
            <div className="card-header">
                ...
                <div className="direct-chat-messages">
                    ...
                    <img className="direct-chat-img" src={`${process.env.PUBLIC_URL}/img/user1-128x128.jpg`} alt="message user image" />
                    ...
                    <img className="direct-chat-img" src={`${process.env.PUBLIC_URL}/img/user3-128x128.jpg`} alt="message user image" />
                    <div className="direct-chat-text">
